...
//let legibleSentence = "The best way to ${word9} your ${word15} ${word9} is during a ${word11} game, like the Superbowl, with friends ${word21} family."
//console.log(legibleSentence)
// 4. Given the string of your full name get your initials.
 //let name = "Elizabeth Ajasin"
 //console.log(name[0])+name[10])

...
let allLower = noCaps.toLowerCase()
...
let allUpper = loud.toUpperCase()

console.log(allUpper)

// Join the prior two variables together.

let joinedString = allLower.concat(allUpper)
...
//Bring these names back together.

let backtoSquareOne = arrayOfNames.join(" ")
...
// let lyricString = "Hey now, you're an all-star!"
// let slicedString = lyricString.slice(19, 27)
...
// let slicedString = greeting.slice(greeting.length-1)
